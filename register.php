...
function do_verify_email($user_name, $pass, $to_mail, $authkey) {
    ...
    $file_name = "mail_templates/mail_verify.tpl";
    ...
    $body = str_replace("<verifyurl>", "http://".$_SERVER['HTTP_HOST'].str_replace("register.php","verify.php", $_SERVER['SCRIPT_NAME'])."?username=".$user_name."&amp;authkey=".$authkey, $body);
